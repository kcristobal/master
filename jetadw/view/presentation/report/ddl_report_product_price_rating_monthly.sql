-- ================================================================================================
-- Name: ddl_report_product_price_rating_monthly.sql
-- Date: 26-Nov-2020
-- Purpose: 
--
-- Change history
...
CREATE OR REPLACE VIEW "JETADW_PROD_PRESENTATION_DB"."REPORT"."REPORT_PRODUCT_PRICE_RATING_MONTHLY"
/*
<LAST AUTHOR> 
    Kristine Cristobal
</LAST AUTHOR>
...
SELECT fpr.product_id
    ...
    ,COUNT(DISTINCT fpr.product_id) AS number_of_unique_products
